...
const file_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x0fauth/auth.proto\x12\x04auth\x1a\x13shared/shared.proto\"@\n" +
	...
	"\x04user\x18\x03 \x01(\v2\f.shared.UserR\x04user\"$\n" +
	"\fTokenRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\"G\n" +
	"\rTokenResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12 \n" +
	"\x04user\x18\x02 \x01(\v2\f.shared.UserR\x04user\":\n" +
	"\x13RefreshTokenRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"9\n" +
	"\x14RefreshTokenResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken2\xc0\x01\n" +
	"\vAuthService\x120\n" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponseB\x0eZ\fsso.v1;ssov1b\x06proto3"
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*User)(nil),                 // 6: shared.User
}
var file_auth_auth_proto_depIdxs = []int32{
	6, // 0: auth.LoginResponse.user:type_name -> shared.User
	6, // 1: auth.TokenResponse.user:type_name -> shared.User
	0, // 2: auth.AuthService.Login:input_type -> auth.LoginRequest
	2, // 3: auth.AuthService.ValidateToken:input_type -> auth.TokenRequest
	...
	3, // 6: auth.AuthService.ValidateToken:output_type -> auth.TokenResponse
